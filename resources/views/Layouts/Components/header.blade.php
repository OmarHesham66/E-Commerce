            ...
            <div class="row align-items-center">
                ...
                {{-- <div class="col-xl-6 col-lg-4">
                    <div class="text-center">
                        <div id="news-flash" class="d-inline-block">
                            <ul>
                                <li>Get great devices up to 50% off <a href="{{ route('get_shop') }}">View details</a>
                                </li>
                                <li>Supper Value Deals - Save more with coupons</li>
                                <li>Trendy 25silver jewelry, save up 35% off today <a
                                        href="{{ route('get_shop') }}">Shop now</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-large">
                            <ul>
                                ...
                                <li class="has-children">
                                    <a href="{{ route('get_shop') }}"><i class="surfsidemedia-font-dress"></i>{{
                                        $super->name }}</a>
                                ...
                                @endforeach
                                {{-- <li><a href="{{ route('get_shop') }}"><i
                                            class="surfsidemedia-font-kite"></i>Outdoor
                                        fun</a></li>
                                <li>
                                    <ul class="more_slide_open" style="display: none;">
                                        <li><a href="{{ route('get_shop') }}"><i
                                                ...
                                                Health</a></li>
                                        <li><a href="{{ route('get_shop') }}"><i class="surfsidemedia-font-cpu"></i>Bags
                                                and
                                                Shoes</a></li>
                                        <li><a href="{{ route('get_shop') }}"><i
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                ...
                                <li><a href="#">My Account(Admin) {{ Auth::user()->name }}<i
                                            class="fi-rs-angle-down"></i></a>
                                    <ul class="sub-menu">
